...
@property(nonatomic, strong) NSLayoutConstraint* verticalSplitTrailingConstraint;
...
@property(nonatomic, strong) NSSegmentedControl* materialTargetModeControl;
...
@property(nonatomic, strong) NSButton* renderLabel;
@property(nonatomic, strong) NSButton* gridLabel;
@property(nonatomic, strong) NSButton* materialLabel;
@property(nonatomic, strong) NSButton* toolbarOverflowControl;
@property(nonatomic, strong) NSMenu* toolbarOverflowMenu;
@property(nonatomic, strong) NSView* toolbarOverflowSpacer;
@property(nonatomic, strong) NSLayoutConstraint* renderControlWidthConstraint;
@property(nonatomic, strong) NSLayoutConstraint* materialPopUpWidthConstraint;
@property(nonatomic, strong) NSLayoutConstraint* gridPopUpWidthConstraint;
@property(nonatomic, strong) NSLayoutConstraint* toolbarOverflowWidthConstraint;
...
@property(nonatomic, strong) NSSegmentedControl* contentBrowserModeControl;
...
@property(nonatomic, assign) BOOL materialApplicationAppliesToFace;
